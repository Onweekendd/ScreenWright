import type { TempPool as TempPoolType } from "@screenwright/types";
import {
  AllEchartEnum,
  BarEchartEnum,
  IndicatorEchartEnum,
...
import type { ComponentType as ComponentTypeOrigin } from "../../type";
...
export type BaseChartProps = ComponentTypeOrigin<componentType>;
