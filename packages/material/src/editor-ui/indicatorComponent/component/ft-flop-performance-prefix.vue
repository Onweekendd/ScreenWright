<template>
  <div class="ft-flop-performance-prefix">
    <el-form-item
      label="是否换行"
    ...
    <el-form-item label="X间距" :label-width="firstLabelWidth">
      <sw-slider
        ...
        :max="100"
        @change="update"
        v-model="selectTargetData[0].option[typeAttrsMap[attrsValue].Splitx]"
      />
    </el-form-item>
    <el-form-item label="Y间距" :label-width="firstLabelWidth">
      <sw-slider
        ...
        :max="100"
        @change="update"
        v-model="selectTargetData[0].option[typeAttrsMap[attrsValue].Splity]"
      />
    </el-form-item>
