<template>
  <div class="ft-flop-performance-value">
    ...
    <SwCollapseItem title="内部设置">
      <template #content>
        ...
        <el-form-item label="X间距" :label-width="secondLabelWidth">
          <sw-slider :min="-100" :max="100" v-model="selectTargetData[0].option.splitx" @change="update" />
          <!-- <sw-slider v-model="selectTargetData[0].option.splitx" @change="update" /> -->
          <!-- <sw-input-number @change="update" v-model="selectTargetData[0].option.splitx" :controls="true" /> -->
        </el-form-item>
        <el-form-item label="Y间距" :label-width="secondLabelWidth">
          <sw-slider :min="-100" :max="100" v-model="selectTargetData[0].option.splity" @change="update" />
          <!-- <sw-input-number @change="update" v-model="selectTargetData[0].option.splity" :controls="true" /> -->
        </el-form-item>
