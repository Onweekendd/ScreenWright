        ...
        <div v-if="currentPic !== null">
          ...
          <sw-collapse-item title="文字" :disabled="false">
            <template #content>
              ...
              <el-form-item label="显示背景" :label-width="thirdLabelWidth">
                <el-checkbox v-model="currentPic.textShowBackground" @change="update" />
              </el-form-item>
              <div v-if="currentPic.textShowBackground">
                <el-form-item label="背景宽度" :label-width="thirdLabelWidth">
                  <sw-input-number
                    v-model.number="currentPic.textWidth"
                    unit="%"
                    :max="100"
                    :min="0"
                    :controls="false"
                ...
                <el-form-item label="背景边距" :label-width="thirdLabelWidth">
                  <div class="flex flex-justify-between" style="width: 100%">
                    <SwInputNumber @change="update" v-model="currentPic.textPaddingTop" width="40" bottomLabel="上" />
                    <SwInputNumber
                      @change="update"
                      v-model="currentPic.textPaddingBottom"
                      width="40"
                      bottomLabel="下"
                    />
                    <SwInputNumber @change="update" v-model="currentPic.textPaddingLeft" width="40" bottomLabel="左" />
                    <SwInputNumber @change="update" v-model="currentPic.textPaddingRight" width="40" bottomLabel="右" />
                  </div>
                </el-form-item>
                <el-form-item label="背景图" :label-width="thirdLabelWidth">
                  <sw-upload
                    v-model="currentPic.textBackground"
                    :multiple="false"
                    :showFileList="false"
                    @change="update"
                    @delete="update"
              ...
              <!-- <el-form-item label="文本框" :label-width="thirdLabelWidth">
                <el-checkbox v-model="currentPic.textShowBackground" @change="update" />
              </el-form-item> -->
            </template>
          </sw-collapse-item>
