...
// 单个数据项的 Schema
const echartthinBarDataItemSchema = z.object({
  name: z.string(),
  value: z.number()
});

// 数据数组 Schema（最终导出的类型）
export const echartthinBarDataSchema = z.array(echartthinBarDataItemSchema);

export type echartthinBarData = z.infer<typeof echartthinBarDataSchema>;
 ...
 * 细长柱状图配置选项 Schema
 */
export const echartthinBarOptionSchema = z.object({
  // ============ 基础配置 ============
...
export type echartthinBarOption = z.infer<typeof echartthinBarOptionSchema>;
