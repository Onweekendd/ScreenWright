...
| 数据源与数据配置     | `data` `dataType` `dataSource` `dataRemark` `dataQuery` `url` `path` `listenArgs` `cbArgs` `openFilter` `enableDataAnalysis` `dataAnalysisName` | [component-base-data.md](references/component-base-data.md)           |
