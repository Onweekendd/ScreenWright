...
| isCursorPointer | boolean | false | 是否显示手型指针 |
...
| aichatQa | object | {...} | AI聊天弹窗配置 |
| aichatQa.fontSize | number | 13 | 聊天字体大小 |
| aichatQa.fontColor | string | "rgba(191,191,191,1)" | 聊天字体颜色 |
| aichatQa.backgroundColor | string | "rgba(36,39,49,0.6)" | 聊天背景颜色 |
| aichatQa.boxWidth | number | 500 | 聊天框宽度 |
| aichatQa.boxHeight | number | 800 | 聊天框高度 |
| aichatQa.qaUrl | string | "" | 问答URL |
| aichatQa.defaultAsk | string | "" | 默认提问内容 |
